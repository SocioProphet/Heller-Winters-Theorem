...
Canonical rules
    ...
    •    Eliminated (×): any n with n<2, or n divisible by 2 or 3 or 5, except n\in\{2,3,5\}.
    •    Wheel-admissible (□): any n\ge 2 with \gcd(n,30)=1, plus 2,3,5.
    •    Wheel modulus: M=30.
    •    Reduced residues:
...
Canonical text-render of matrix
...
TYPESSETTING SPEC (so the final graphic matches the canonical render exactly)
